...
from ptb_loscar_p_sr_timelag_30 import parameters, init_start, model_run
...
temp_loess = pd.read_excel('for_multi_inversion.xlsx', sheet_name = 'T_loess_30').to_numpy()
...
d13c_loess = pd.read_excel('for_multi_inversion.xlsx', sheet_name = 'd13c_loess_30').to_numpy()

sclim = 4.5

exp_name = f'd13c_sens_test_timelag_30'
