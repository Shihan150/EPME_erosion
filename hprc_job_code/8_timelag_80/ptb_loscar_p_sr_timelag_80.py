...
def init_start(params):
    ...
    if len(erosion_factor) == 3:
        ...
        fscale_erosion =interpolate.interp1d([-252.03e6, -251.991e6, -251.954e6, -251.94e6, -251.92e6, -251.899e6], [erosion_factor[0], erosion_factor[1], erosion_factor[2], erosion_factor[3], erosion_factor[4],1], bounds_error = False, kind = 'zero', fill_value = 1)
    ...
    if RUN_TYPE == 0 or RUN_TYPE == 3:
        ...
        if len(cinp) == 3:
            ...
            fcinp = interpolate.interp1d([-252.03e6, -251.991e6, -251.954e6, -251.94e6, -251.92e6, -251.899e6], [cinp[0], cinp[1], cinp[2], cinp[3], cinp[4],0], bounds_error = False, kind = 'zero', fill_value = 0)
        elif len(cinp) == 10:
