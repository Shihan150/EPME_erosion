...
def log_probability(theta, exp_name = 'test', switch = 1):
    ...
    if not np.isfinite(lp):
        ...
        try:
            ...
            params['initfile'] = 'ptb_steady_silw11_carbw17'
            params['fsi0'] = 11
            # params['finc0'] = 17
...
if __name__ == '__main__':
    ...
    params = parameters(d13cin = 2, d13cvc = -1.8, svresults = 1, printflag = 0, pcycle = 0, LOADFLAG = 0, svstart = 1, cinpflag = 0, cinp = 6e3, tcspan = 6e4,  dccinp = -25, nsi = 0.4, sclim = sclim)
    params['t0'] = 0
    params['tfinal'] = 2e7
    params['fsi0'] = 11
    # params['finc0'] = 17
    params['svfile'] = 'ptb_steady_silw11_carbw17'
    params['initfile'] = 'ptb_steady_silw11_carbw17'
    init_start(params)
