...
samples = np.load(f'./mcmc_results/{exp_name}.npy')
pr = np.loadtxt(f'./mcmc_results/ln_{exp_name}.dat')
...
np.save(f'./mcmc_forward_results/{exp_name}_forcing_mcmc', post_chain)
